...
async function home() {
  ...
  document.getElementById("main").innerHTML =
    ...
    username +
    `</span>.</h1><div class="onlymobile mt-5 mb-5 text-center"><a onclick="games()" class="btn btn-primary"><i class="bi bi-suit-spade-fill me-1"></i> Go to Games <i class="bi bi-suit-spade-fill ms-1"></i></a></div><div class="card"><h5 class="card-header"><i class="bi bi-newspaper me-1"></i> News</h5><div class="card-body">` +
