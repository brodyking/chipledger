...
async function home() {
  ...
  document.getElementById("main").innerHTML =
    ...
    username +
    `</span>.</h1><div class="card"><h5 class="card-header"><i class="bi bi-newspaper me-1"></i> News</h5><div class="card-body">` +
    cache["releaseNotes"]["data"] +
    `</div></div>`;
}

// Donation page. Calls API to get donation page content.
