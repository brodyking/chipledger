...
`;
  ...
  navHtml +=
    ...
    `
        ...
        <div class="modal fade border" id="mobilenavmodal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-fullscreen p-2" style="height: -webkit-fill-available;">
                <div class="modal-content rounded border" id="mobilenavmodalbody">
                    <div class="modal-header w-100 rounded-top">
  ...
  navLinks.forEach((element) => {
    navHtml +=
      `<div class="mb-3"><a data-bs-dismiss="modal" class="btn btn-lg btn-primary text-start w-100" onclick="` +
      element[3] +
      `"><i class="align-middle bi ` +
      element[2] +
      ` me-1"></i> ` +
  ...
  <hr>
                        <div class="mb-3">
                          <a class="btn btn-lg btn-success text-start w-100" href="/blog"><i class="bi bi-pencil me-1"></i> Blog</a>
                        </div>
                        <div class="mb-3">
                          <a class="btn btn-lg btn-success text-start w-100" href="/docs"><i class="bi bi-book me-1"></i> Docs</a>
                        </div>
                          <div class="mb-3">
                          <a class="btn btn-lg btn-success text-start w-100" href="/donate"><i class="bi bi-heart me-1"></i> Donate</a>
                        </div>
  <hr>
                        <div class="mb-3">
                          <a class="btn btn-lg btn-warning text-start w-100" data-bs-dismiss="modal" onclick="settings();"><i class="bi bi-gear me-1"></i> Settings</a>
                        </div>
                        <div class="mb-3">
                          <a class="btn btn-lg btn-warning text-start w-100" href="/api/auth/logout"><i class="bi bi-door-open me-1"></i> Logout</a>
                        </div>
                      </div>
                </div>
            </div>
