function showNav(pageSelected) {
  navLinks = [
    ...
    ["/home", "Home", "bi-house-door", "home();", "ffffff8c", "success"],
    ["/games", "Games", "bi-suit-spade", "games();", "ffffff8c", "primary"],
    ["/donate", "Donate", "bi-heart", "donate();", "ffffff8c", "warning"],
    ["/docs", "Docs", "bi-book", "document.location.href = `docs/`;", "ffffff8c", "warning"],
  ];
...
`;
  ...
  navLinks.forEach((element) => {
    navHtml +=
      `<div class="mb-3"><a class="btn btn-lg btn-` +
      element[5] +
      ` w-100" data-bs-dismiss="modal" onclick="` +
      element[3] +
      `"><i class="align-middle bi ` +
      element[2] +
      ` me-1"></i> ` +
  ...
  navHtml += `<hr>
                        <div class="mb-3">
                          <a class="btn btn-lg btn-secondary w-100" data-bs-dismiss="modal" onclick="settings()"><i class="bi bi-gear me-1"></i>Settings</a>
                        </div>
                        <div class="mb-3">
                          <a class="btn btn-lg btn-secondary w-100" href="/api/auth/logout"><i class="bi bi-door-open me-1"></i>Logout</a>
                        </div>
                      </div>
                </div>
            </div>
