  ...
  if (paramList["game"] === undefined) {
    ...
    function baserender() {
      document.getElementById("main").innerHTML =
        `
        <nav class="navbar border fixed-bottom navbar-dark bg-body-tertiary onlymobile-flex m-2 rounded-5 p-0" style="bottom:60px!important;background-color: rgb(43, 43, 43, 0.5)!important;backdrop-filter: blur(10px);" id="mobile-game-nav">
          <div class="btn-group w-100" role="group" aria-label="Basic example">
            <button type="button" class="btn btn-link text-decoration-none w-100" ref="#" data-bs-toggle="modal" data-bs-target="#newplayermodal"><i class="bi bi-person-fill"></i><br>New Player</button>
            <button type="button" class="btn btn-link text-decoration-none w-100" ref="#" data-bs-toggle="modal" data-bs-target="#newbuyinmodal"><i class="bi bi-wallet-fill"></i><br>New Buyin</button>
            <button type="button" class="btn btn-link text-decoration-none w-100" ref="#" data-bs-toggle="modal" data-bs-target="#newcashoutmodal"><i class="bi bi-piggy-bank-fill"></i><br>New Cashout</button>
          </div>
        </nav>
                    ...
                    <div class="collapse multi-collapse show" id="paymentMethodStatsBody">
                      <div class="card-body p-2">
                        <div class="accordion accordion-flush">
                          ...
                          <div class="accordion-item mb-2 border-0">
                            <h2 class="accordion-header">
                              <button class="btn text-start btn-success bg-success-emphesis w-100 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#methodsCashapp" aria-expanded="false" aria-controls="flush-collapseOne">
